...
def univariate_backward_selection(X, y):

    path_to_results = './50evals_50reps_dtree_univariate_sbs_dfs.csv'
...
if __name__ == '__main__':
    path_to_results = './50evals_50reps_boosting_dfs.csv'
    ...
    univariate_backward_selection(X, y)
