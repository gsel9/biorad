...
if __name__ == '__main__':
    ...
    from algorithms.transforms import BinaryThreshold
    from algorithms.classification import TsetlinMachineWrapper
    ...
    path_to_results = './50evals_50reps_tsetlin_dfs.csv'
    ...
    estimators = {
        TsetlinMachine.__name__: TsetlinMachineWrapper(),
    }
    selectors = {
        BinaryThreshold.__name__: BinaryThreshold(),
    }
