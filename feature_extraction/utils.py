...
if __name__ == '__main__':
    # Demo run.
    path_masksdir = './../../data_source/images/masks_slice_drop_ct1300_nrrd/'
    path_ct_imagedir = './../../data_source/images/ct_slice_drop_ct1300_nrrd/'
    path_pet_imagedir = './../../data_source/images/pet_slice_drop_ct1300_nrrd/'

    paths_ct_images = sample_paths(
        path_ct_imagedir, path_masksdir, target_format='nrrd'
    )
    paths_pet_images = sample_paths(
